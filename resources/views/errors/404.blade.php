...
<body>
    <div class="flex items-center justify-center w-10/12 m-auto">
        ...
        <div class="hidden md:flex md:w-1/2 p-8">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                ...
                <g id="freepik--Planets--inject-63">
                    ...
                    <path d="M155.06,103.62a2,2,0,1,1-2-2A2,2,0,0,1,155.06,103.62Z" style="fill:#407BFF;opacity:0.2">
                    </path>
        ...
        <div class="w-full md:w-1/2 p-4 md:p-8">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-800 mb-4">404 Halaman tidak Ditemukan!</h1>
            <p class="text-lg md:text-xl text-gray-600 mb-8">Oops! Ada sesuatu yang salah pada url kamu, sehingga tidak
                ditemukan.</p>
            <button onclick="history.back()"
                class="px-6 py-3 bg-blue-500 text-white rounded-lg inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Kembali..</button>
        </div>
    </div>
    <script>
        $(".preloader").fadeOut();
