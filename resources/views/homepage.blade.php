        ...
        <div class="container flex flex-col items-center mx-auto px-2 lg:px-10 my-8 lg:my-16">
            ...
            <div class="grid w-full grid-cols-2 gap-4 text-center lg:gap-10 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex flex-col items-center gap-1 px-2 py-4 bg-white rounded-xl border-2 shadow-main">
                    ...
                    <p class="text-base font-semibold lg:text-2xl lg:font-semibold text-dark-grey-900">Cari Bidang Keahlian
                    </p>
                    <p class="lg:text-base text-xs text-dark-grey-400">Pilih bidang keahlian tukang bangunan sesuai
                        kebutuhan</p>
                </div>
                <div class="flex flex-col items-center gap-1 px-2 py-4 bg-white rounded-xl border-2 shadow-main">
                    <span>
                    ...
                    <p class="text-base font-semibold lg:text-2xl lg:font-semibold text-dark-grey-900">Seleksi Tukang
                        Bangunan</p>
                    <p class="lg:text-base text-xs text-dark-grey-400">Pilih dan seleksi tukang bangunan berdasarkan
                        kebutuhan</p>
                </div>
