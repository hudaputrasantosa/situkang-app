                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button type="button" class=" items-center justify-center text-gray-900"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="disabledTextInput" class="form-label">Deskripsi
                                                    Kebutuhan</label>
                                                <input type="text" class="form-control" value="{{ $sewa->deskripsi }}"
                                                    readonly>
                                            </div>
                                            <div class="flex lg:flex-row flex-col w-full gap-x-4 gap-y-2 mb-2">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    @if ($sewa->tipe_pembayaran !== 'bank')
                                                        <input type="text" class="form-control" value="Bayar Ditempat"
                                                            readonly>
                                                    @else
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <h5><span class="font-semibold text-xl">@currency($sewa->harga)</span>
                                                </h5>
                                            </div>
